...
from components.common import get_circuit
...
def run(v):
    ...
    if app_select.value == 'Function encoding':
        ...
        input_select = pn.widgets.Select(name="Type of input", options=['Integer variable', 'Binary variables'], value='Integer variable')
    ...
    if app_select.value == 'Frequency encoding':
        ...
        frequency = pn.widgets.FloatInput(name="Frequency", value=4.3)
        go = pn.widgets.Button(name='Apply', button_type='primary')
